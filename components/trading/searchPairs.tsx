                    ...
                    <tbody>
                        {
                            Array.from({ length: 20 }).map((_, index) => (
                                <tr className='relative' key={index}>
                                    ...
                                    <td style={{ width: (((Math.floor(1 + Math.random() * 100))) / 20) * 100, background: "linear-gradient(90deg, rgba(11,186,116,0.1), rgba(11,186,116,0.2)"}} className={`absolute right-0 h-full`}></td>
                                </tr>
                            ))
                        }
                    </tbody>
